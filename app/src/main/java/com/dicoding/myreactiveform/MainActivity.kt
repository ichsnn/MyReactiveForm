...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val emailStream = RxTextView.textChanges(binding.edEmail).skipInitialValue()
        ...
        val passwordStream = RxTextView.textChanges(binding.edEmail)
            .skipInitialValue()
            .map { passsword -> passsword.length < 6 }
        ...
        val passwordConfirmationStream = Observable.merge(
            ...
            RxTextView.textChanges(binding.edConfirmPassword).map { confirmPassword ->
